...
% dbstop if error;
    ...
    load('spatialLocalizationStimuli.mat');
    ...
    for iBlock=1:exptdesign.numBlocks
        ...
        save(['./data/' exptdesign.number '/' datestr(now, 'yyyymmdd_HHMM') '-' exptdesign.subjectName '_block' num2str(iBlock) '.' num2str(iTrial) '.mat'], 'trialOutput', 'exptdesign','practiceTrialOutput');
