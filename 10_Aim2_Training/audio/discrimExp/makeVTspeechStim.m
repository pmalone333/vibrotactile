...
%% same/diff pairs for discrim task
stimSame = {{'aba','aba'},{'ada','ada'},{'aza','aza'},{'ata','ata'},{'ana','ana'},{'ama','ama'}, ...
{'asa','asa'},{'apa','apa'},{'ava','ava'},{'afa','afa'},{'aga','aga'},{'aka','aka'}};

stimDiff = {{'aba','aba'},{'ada','ada'},{'aza','aza'},{'ata','ata'},{'ana','ana'},{'ama','ama'}, ...
{'asa','asa'},{'apa','apa'},{'ava','ava'},{'afa','afa'},{'aga','aga'},{'aka','aka'}};
