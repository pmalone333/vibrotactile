...
data_path = dir(fullfile('C:\Users\User\Desktop\vibrotactile\10_Aim2_Training\data',subj, [sessDate '*_block6.mat']));
load(fullfile('C:\Users\User\Desktop\vibrotactile\10_Aim2_Training\data',subj, data_path(1).name));
...
subplot(3,1,1); 
bar(voice_acc_2);
set(gca,'xticklabels',{'aba/apa','ada/ata','ava/afa','aga/aka','aza/asa','total'})
...
subplot(3,1,2); 
bar(place_acc_2);
set(gca,'xticklabel',{'apa/ata','aba/aga','ava/aza','afa/asa','ama/ana','total'})
...
subplot(3,1,3); 
bar(manner_acc_2);
set(gca,'xticklabel',{'ada/aza','aza/ana','aba/ama','ada/ana','ata/asa', 'total'})
title(['sub' subj ' - manner - ' sessDate]);
ylim([0 1])
hline = refline([0 0.5]);
hline.Color = 'r';
saveas(gcf,fullfile('C:\Users\User\Desktop\vibrotactile\10_Aim2_Training\data',subj,[subj '_' sessDate '_all.jpg']))
%close all
...
saveas(gcf,fullfile('C:\Users\User\Desktop\vibrotactile\10_Aim2_Training\data',subj, [subj '_' sessDate '_featuresOverall.jpg']))
%close all
...
saveas(gcf,fullfile('C:\Users\User\Desktop\vibrotactile\10_Aim2_Training\data',subj, [subj '_' sessDate '_featuresTotal.jpg']))
