function plotTrainingProgressLevel3(exptFilename, saveName)

    %exptData = load(exptFilename);
    
    exptData = load('/Volumes/KINGSTON/915/20150819_1124-MR915_block6.mat');
    ...
    for i=1:numBlocks
        indexL1(i,:) = ismember(exptData.trialOutput(i).stimuli(1,:),[f1(1:4) f2(1:4)]);
        indexL2(i,:) = ismember(exptData.trialOutput(i).stimuli(1,:),[f1(1:2:7) f2(1:2:7)]);
        indexL3(i,:) = ismember(exptData.trialOutput(i).stimuli(1,:),[f1(2:2:8) f2(2:2:8)]);
        indexL4(i,:) = ismember(exptData.trialOutput(i).stimuli(1,:),[f1(6:9) f2(6:9)]);
    end
