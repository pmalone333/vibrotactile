...
clear all;
for i = 1:10
    session(i) = load('Volumes/KINGSTON/*.mat');
end

%%
%mean acc by pos and session at L1
if isfield(s1,'accP1sameL1')==1
...
if isfield(s1,'accP1sameL4')==1
    s1.tAccP1L4 = [s1.accP1crossL4; s1.accP1sameL4];
    s1.tAccP2L4 = [s1.accP2crossL4; s1.accP2sameL4];
    s1.tAccP3L4 = [s1.accP3crossL4; s1.accP3sameL4];
    s1.tAccP4L4 = [s1.accP4crossL4; s1.accP4sameL4];
end

if isfield(s4,'accP1sameL4')==1
    s4.tAccP1L4 = [s4.accP1crossL4; s4.accP1sameL4];
    s4.tAccP2L4 = [s4.accP2crossL4; s4.accP2sameL4];
    s4.tAccP3L4 = [s4.accP3crossL4; s4.accP3sameL4];
    s4.tAccP4L4 = [s4.accP4crossL4; s4.accP4sameL4];
end

if isfield(s5,'accP1sameL4')==1
    s5.tAccP1L4 = [s5.accP1crossL4; s5.accP1sameL4];
    s5.tAccP2L4 = [s5.accP2crossL4; s5.accP2sameL4];
    s5.tAccP3L4 = [s5.accP3crossL4; s5.accP3sameL4];
    s5.tAccP4L4 = [s5.accP4crossL4; s5.accP4sameL4];
end

if isfield(s6,'accP1sameL4')==1
    s6.tAccP1L4 = [s6.accP1crossL4; s6.accP1sameL4];
    s6.tAccP2L4 = [s6.accP2crossL4; s6.accP2sameL4];
    s6.tAccP3L4 = [s6.accP3crossL4; s6.accP3sameL4];
    s6.tAccP4L4 = [s6.accP4crossL4; s6.accP4sameL4];
end

if isfield(s7,'accP1sameL4')==1
    s7.tAccP1L4 = [s7.accP1crossL4; s7.accP1sameL4];
    s7.tAccP2L4 = [s7.accP2crossL4; s7.accP2sameL4];
    s7.tAccP3L4 = [s7.accP3crossL4; s7.accP3sameL4];
    s7.tAccP4L4 = [s7.accP4crossL4; s7.accP4sameL4];
end

if isfield(s8,'accP1sameL4')==1
    s8.tAccP1L4 = [s8.accP1crossL4; s8.accP1sameL4];
    s8.tAccP2L4 = [s8.accP2crossL4; s8.accP2sameL4];
    s8.tAccP3L4 = [s8.accP3crossL4; s8.accP3sameL4];
    s8.tAccP4L4 = [s8.accP4crossL4; s8.accP4sameL4];
end
